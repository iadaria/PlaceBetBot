...
{
    [TestClass]
    public class DoubleWinBetTests
    {
        ...
        private JToken ToValidateCouponBySite
        {
            get
            {
                var json = "{\"requestCoupon\":{\"type\":\"RCT_SYSTEM\",\"odds\":[-1,-1],\"outcomeIds\":[[2698427847],[2698427943]],\"selection\":[[],[]],\"betsPattern\":\"111\",\"isUserLoggedIn\":true}}";
        ...
        private JToken CheckedCouponBySite
        {
            get
            {
                var json = "{\"responseCoupon\":{\"status\":200,\"requestCoupon\":{\"type\":\"RCT_SYSTEM\",\"outcomeIds\":[[2698427847],[2698427943]],\"odds\":[-1,-1],\"betsPattern\":\"111\",\"allowOddsChange\":\"AOCT_NO\",\"selection\":[[],[]],\"suggestedRetailPunterCategory\":null}}}";
