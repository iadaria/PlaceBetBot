...
{
    [TestClass]
    public class TrebleWinBetTests
    {
        ...
        private JToken PlaceBetBySite
        {
            get
            {
                var json = 
                    ...
                    "\"requestCoupon\":{\"allowOddsChange\":\"AOCT_NO\",\"odds\":[-1,-1,-1],\"stakes\":[10],\"outcomeIds\":[[2698427847],[2698427943],[2698428181]],\"type\":\"RCT_COMBINATION\",\"eachWayFraction\":[250,200,250],\"eachWayPlaceLimit\":[2,3,3],\"selection\":[[],[],[]]}}";
                return JToken.Parse(json);
            }
        }
        /****************************************/
