...
{
    [TestClass]
    public class TrebleBetTests
    {
        private BetType betType;
        private double stake;
        private bool ew;
        private Placer.Ecambi.BetslipHelper helper;
        ...
        private JToken PlaceBetBySite
        {
            get
            {
                var json = "{\"id\":1,\"trackingData\":{\"hasTeaser\":false,\"isBetBuilderCombination\":false,\"selectedOutcomes\":[{\"id\":2698427847,\"outcomeId\":2698427847,\"betofferId\":2198202574,\"eventId\":1006029936,\"oddsApproved\":true,\"approvedEachWayFractionMilli\":250,\"approvedEachWayPlaceLimit\":2,\"eachWayFractionMilli\":250,\"eachWayPlaceLimit\":2,\"eachWayApproved\":true,\"isLiveBetoffer\":false,\"isPrematchBetoffer\":true,\"fromBetBuilder\":false,\"source\":\"Event List View\"}," +
                    ...
                    "\"requestCoupon\":{\"allowOddsChange\":\"AOCT_NO\",\"odds\":[-1,-1,-1],\"stakes\":[10],\"outcomeIds\":[[2698427847],[2698427943],[2698428181]],\"type\":\"RCT_COMBINATION\",\"selection\":[[],[],[]]}}";
                return JToken.Parse(json);
            }
        }
