...
namespace MyTester
{
    ...
    public class FivefoldBetTests
    {
        ...
        private JToken ToValidateCouponBySite
        {
            get
            {
                var json = "{\"requestCoupon\":{\"type\":\"RCT_SYSTEM\",\"odds\":[-1,-1,-1,-1,-1],\"outcomeIds\":[[2698429397],[2698429472],[2698429509],[2698429540],[2698429573]],\"selection\":[[],[],[],[],[]],\"betsPattern\":\"1111111111111111111111111111111\",\"isUserLoggedIn\":true}}";
        ...
        private JToken CheckedCouponBySite
        {
            get
            {
                var json = "{\"responseCoupon\":{\"status\":200,\"requestCoupon\":{\"type\":\"RCT_SYSTEM\",\"outcomeIds\":[[2698429397],[2698429472],[2698429509],[2698429540],[2698429573]],\"odds\":[-1,-1,-1,-1,-1],\"betsPattern\":\"1111111111111111111111111111111\",\"allowOddsChange\":\"AOCT_NO\",\"selection\":[[],[],[],[],[]],\"suggestedRetailPunterCategory\":null}}}";
        ...
        private JToken PlaceBetBySite
        {
            get
            {
                var json =
                  ...
                  "{\"id\":2698429540,\"outcomeId\":2698429540,\"betofferId\":2198205744,\"eventId\":1006030023,\"oddsApproved\":true,\"approvedEachWayFractionMilli\":250,\"approvedEachWayPlaceLimit\":2,\"eachWayFractionMilli\":250,\"eachWayPlaceLimit\":2,\"eachWayApproved\":true,\"isLiveBetoffer\":false,\"isPrematchBetoffer\":true,\"fromBetBuilder\":false,\"source\":\"Event List View\"}," +
                  ...
                  "\"requestCoupon\":{\"allowOddsChange\":\"AOCT_NO\",\"odds\":[-1,-1,-1,-1,-1],\"stakes\":[10],\"outcomeIds\":[[2698429397],[2698429472],[2698429509],[2698429540],[2698429573]],\"type\":\"RCT_COMBINATION\",\"selection\":[[],[],[],[],[]]}}";
                return JToken.Parse(json);
            }
        }
        /****************************************/
